INSERT INTO pages (title, route, content, format, draft, hidden, auth_required) 
SELECT 'Rules of Engagement', 'rules', '<div class="obv-container obv-page">
  <div class="obv-intel-doc">
    ...
    <div class="obv-intel-doc__body obv-animate-entry">
...
WHERE NOT EXISTS (
    SELECT 1 FROM pages WHERE route = 'rules'
);
